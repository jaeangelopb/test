...
{
    public static class GetConsolidatedSTISummaryFunc
    {
        [FunctionName("GetConsolidatedSTISummaryFunc")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "GET", Route = "GetConsolidatedSTISummary")] HttpRequest req,
            ILogger log)
        {
            ...
            using (SqlConnection conn = new SqlConnection(str))
            {
                ...
                if (type.Equals("STISummary"))
                {
                    ...
                    procName = "[WorkPaper].[sp_Consol_STI_Workpaper_Summary]";
