...
{
    public static class GetConsolDTMFunc
    {
        [FunctionName("GetConsolDTMFunc")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "GET", Route = "GetConsolDTM")] HttpRequest req,
            ILogger log)
        {
            ...
            using (SqlConnection conn = new SqlConnection(str))
            {
                ...
                if (type.Equals("ConsolDTM"))
                {
                    ...
                    procName = "[WorkPaper].[sp_Consol_DTM_Workpaper]";
                }
        ...
        {
            DataTable dataTable = new DataTable { TableName = "DTMSummary" };
