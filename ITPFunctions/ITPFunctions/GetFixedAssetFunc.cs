...
{
    public static class GetFixedAssetFunc
    {
        [FunctionName("GetFixedAssetFunc")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "GetFixedAsset")] HttpRequest req,
            ILogger log)
        {
            ...
            {
                conn.Open();                
                text = "SELECT * FROM WorkPaper.vw_FAR_List " +
...

        {
            ...
            DataTable dataTable = new DataTable { TableName = "FixedAsset" };
