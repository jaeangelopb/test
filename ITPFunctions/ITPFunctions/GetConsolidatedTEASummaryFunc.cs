...
{
    public static class GetConsolidatedTEASummaryFunc
    {
        [FunctionName("GetConsolidatedTEASummaryFunc")]
        public static async Task<IActionResult> Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "GET", Route = "GetConsolidatedTEASummary")] HttpRequest req,
        ILogger log)
        {
...
                SqlParameter GroupingNameParam = new SqlParameter();
                ...
                if (type.Equals("ConsolidatedTEA"))
                {
                    ...
                    procName = "[WorkPaper].[sp_Consol_TEASummary]";
                }
