...
{
    public static class GetPAAdjustmentFunc
    {
        [FunctionName("GetPAAdjustmentFunc")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "GetPAAdjustment")] HttpRequest req,
            ILogger log)
        {
            ...
            using (SqlConnection conn = new SqlConnection(str))
            {
                ...
                {
                    text = "SELECT * FROM [WorkPaper].[vw_PAAdjustments_Workpaper]" +
                         " where [EntityId]=" + EntityId + " " +
                         "AND [Period] = '" + Period + "' AND [Process]='" + Process + "'";
                    //  text = "SELECT * FROM [WorkPaper].[vw_PAAdjustments_Workpaper] where [EntityId]=" + EntityId;
                }
...

        {
            ...
            DataTable dataTable = new DataTable { TableName = "PooledAssets" };
