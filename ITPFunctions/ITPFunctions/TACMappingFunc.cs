...
{
    public static class TACMappingFunc
    {
        [FunctionName("TACMappingFunc")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "TACMapping")] HttpRequestMessage req,
              ILogger log)
        {
            ...
            using (SqlConnection conn = new SqlConnection(str))
            {
                ...
                foreach (ChartOfAccount rowItem in coa)
                {
                        ...
                        DR["AccountTypeId"] = rowItem.AccountTypeId;
                        DR["TaxSensitivityId"] = rowItem.TaxSensitivityId;
                        ...
                        DR["SourceSystem"] = rowItem.SourceSystem;
                        DR["CreatedBy"] = UserID;
