...
{
    public static class GetDividendComponentsFunc
    {
        [FunctionName("GetDividendComponentsFunc")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "GetDividendComponents")] HttpRequest req,
            ILogger log)
        {
            ...
            using (SqlConnection conn = new SqlConnection(str))
            {
                ...
                {
                    text = "SELECT * FROM [WorkPaper].[vw_DividendComponents_List] " +
...

        {
            ...
            DataTable dataTable = new DataTable { TableName = "DividendComponents" };
