...
{
    public static class GetConsolidatedETRSummaryFunc
    {
        [FunctionName("GetConsolidatedETRSummaryFunc")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "GET", Route = "GetConsolidatedETRSummary")] HttpRequest req,
            ILogger log)
        {
            ...
            using (SqlConnection conn = new SqlConnection(str))
            {
                ...
                if (type.Equals("Consol_ETRSummary"))
                {
                    ...
                    procName = "[WorkPaper].[sp_Consol_ETRSummary_Pivot]";

                }

                else if (type.Equals("Consol_ETRTEACheck"))
                {
                    GroupingNameParam.ParameterName = "@GroupingName";
                    PeriodParam.ParameterName = "@Period";
                    ProcessParam.ParameterName = "@Process";
                    EntityIdParam.ParameterName = "@EntityId";
                    procName = "[WorkPaper].[sp_Consol_ETRSummaryTotal_Pivot]";
