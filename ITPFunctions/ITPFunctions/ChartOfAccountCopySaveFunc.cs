...
{
    public static class ChartOfAccountCopySaveFunc
    {
        [FunctionName("ChartOfAccountCopySaveFunc")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "ChartOfAccountCopySave")] HttpRequestMessage req,
              ILogger log)
        {
            ...
            var fra = JsonConvert.DeserializeObject<IEnumerable<COAEntityMapping>>(body as string);
            ...
            using (SqlConnection conn = new SqlConnection(str))
            {
                ...
                procName = "[Core].[sp_ChartOfAccount_BulkCopy]";
