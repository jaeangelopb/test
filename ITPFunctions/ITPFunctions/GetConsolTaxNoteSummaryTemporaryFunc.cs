...
{
    public static class GetConsolTaxNoteSummaryTemporaryFunc
    {
        [FunctionName("GetConsolTaxNoteSummaryTemporaryFunc")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "GET", Route = "GetConsolTaxNoteSummaryTemporary")] HttpRequest req,
            ILogger log)
        {
            ...
            using (SqlConnection conn = new SqlConnection(str))
            {
                ...
                if (type.Equals("Temporary"))
                {
                    ...
                    procName = "[WorkPaper].[sp_Consol_TaxNoteSummary_Temporary]";
                ...
                else if (type.Equals("TemporarySummary"))
                {
                    GroupingNameParam.ParameterName = "@GroupingName";
                    PeriodParam.ParameterName = "@Period";
                    ProcessParam.ParameterName = "@Process";
                    EntityIdParam.ParameterName = "@EntityId";
                    procName = "[WorkPaper].[sp_Consol_TaxNoteSummary_Temporary_Summary]";
...
                    try
        ...
        {
            DataTable dataTable = new DataTable { TableName = "TaxNoteSummary" };
