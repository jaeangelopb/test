...
{
    public static class GetTrialBalanceFunc
    {
        [FunctionName("GetTrialBalanceFunc")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "GetTrialBalance")] HttpRequest req,
            ILogger log)
        {
            ...
            using (SqlConnection conn = new SqlConnection(str))
            {
                ...
                {
                    text = "SELECT * FROM [Core].[vw_TrialBalance_List] " +
                        " where [EntityId]=" + EntityId + " AND [Period]='" + Period + "'";
                }
...

        {
            ...
            DataTable dataTable = new DataTable { TableName = "TrialBalance" };
