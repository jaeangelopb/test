...
{
    public static class COAMappingLibrarySaveFunc
    {
        [FunctionName("COAMappingLibrarySaveFunc")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "COAMappingLibrarySave")] HttpRequestMessage req,
              ILogger log)
        {
            ...
            using (SqlConnection conn = new SqlConnection(str))
            {
                ...
                using (SqlCommand cmd = new SqlCommand("[Common].[sp_COA_MappingLibrary_BulkSave]", conn))
                {
