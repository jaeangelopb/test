...
{
    public static class GetConsolidatedFormCFunc
    {
        [FunctionName("GetConsolidatedFormCFunc")]
        public static async Task<IActionResult> Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "GET", Route = "GetConsolidatedFormC")] HttpRequest req,
        ILogger log)
        {
...
                SqlParameter GroupingNameParam = new SqlParameter();
                ...
                if (type.Equals("ConsolidatedFormC"))
                {
                    ...
                    procName = "[WorkPaper].[sp_Consol_FormC]";
                }
