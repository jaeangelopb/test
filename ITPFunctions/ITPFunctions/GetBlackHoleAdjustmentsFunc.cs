...
{
    public static class GetBlackHoleAdjustmentsFunc
    {
        [FunctionName("GetBlackHoleAdjustmentsFunc")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "GetBlackHoleAdjustments")] HttpRequest req,
            ILogger log)
        {
            ...
            using (SqlConnection conn = new SqlConnection(str))
            {
                ...
                {
                    text = "SELECT * FROM [WorkPaper].[vw_BlackHole_Workpaper]" +
...

        {
            ...
            DataTable dataTable = new DataTable { TableName = "BlackHoleAdjustments" };
