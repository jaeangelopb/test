...
{
    public static class GetFITOAdjustmentsFunc
    {
        [FunctionName("GetFITOAdjustmentsFunc")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "GetFITOAdjustments")] HttpRequest req,
            ILogger log)
        {
            ...
            using (SqlConnection conn = new SqlConnection(str))
            {
                ...
                {
                    text = "SELECT * FROM [WorkPaper].[vw_FITOAdjustments] " +
...

        {
            ...
            DataTable dataTable = new DataTable { TableName = "FITOAdjustments" };
