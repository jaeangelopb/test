...
{
    public static class GetConsolidatedTEASummaryFooterFunc
    {
        [FunctionName("GetConsolidatedTEASummaryFooterFunc")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "GET", Route = "GetConsolidatedTEASummaryFooter")] HttpRequest req,
            ILogger log)
        {
            ...
            using (SqlConnection conn = new SqlConnection(str))
            {
                ...
                if (type.Equals("ConsolidatedTEAFooter"))
                {
                    ...
                    procName = "[WorkPaper].[sp_Consol_TEASummary_FooterSP]";
