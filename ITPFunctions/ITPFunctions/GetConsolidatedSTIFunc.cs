...
{
    public static class GetConsolidatedSTIFunc
    {
        [FunctionName("GetConsolidatedSTIFunc")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "GET", Route = "GetConsolidatedSTI")] HttpRequest req,
            ILogger log)
        {
            ...
            using (SqlConnection conn = new SqlConnection(str))
            {
                ...
                if (type.Equals("ConsolidatedSTI"))
                {
                    ...
                    procName = "[WorkPaper].[sp_Consol_STI_Workpaper]";
