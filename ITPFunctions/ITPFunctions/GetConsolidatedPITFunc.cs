...
{
    public static class GetConsolidatedPITFunc
    {
        [FunctionName("GetConsolidatedPITFunc")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "GET", Route = "GetConsolidatedPIT")] HttpRequest req,
            ILogger log)
        {
            ...
            using (SqlConnection conn = new SqlConnection(str))
            {
                ...
                if (type.Equals("ConsolidatedPIT"))
                {
                    ...
                    procName = "[WorkPaper].[sp_Consol_PIT_Workpaper]";
                }
        ...
        {
            DataTable dataTable = new DataTable { TableName = "PITSummary" };
