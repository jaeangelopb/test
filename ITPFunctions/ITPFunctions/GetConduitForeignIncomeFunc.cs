...
{
    public static class GetConduitForeignIncomeFunc
    {
        [FunctionName("GetConduitForeignIncomeFunc")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "GetConduitForeignIncome")] HttpRequest req,
            ILogger log)
        {
            ...
            using (SqlConnection conn = new SqlConnection(str))
            {
                ...
                {
                    text = "SELECT * FROM [WorkPaper].[vw_ConduitForeignIncome] " +
