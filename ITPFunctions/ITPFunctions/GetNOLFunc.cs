...
{
    public static class GetNOLFunc
    {
        [FunctionName("GetNOLFunc")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "GetNOLFunc")] HttpRequest req,
            ILogger log)
        {
            ...
            {
                conn.Open();
                text = "SELECT * FROM WorkPaper.vw_NOL_Workpaper " +
