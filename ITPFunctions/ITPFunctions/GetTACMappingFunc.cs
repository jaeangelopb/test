...
{
    public static class GetTACMappingFunc
    {
        [FunctionName("GetTACMappingFunc")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "GetTACMapping")] HttpRequest req,
            ILogger log)
        {
            ...
            using (SqlConnection conn = new SqlConnection(str))
            {
                ...
                {
                    text = "SELECT * FROM [Common].[vw_TACMApping_List] " +
                        "where MappingName='" + TBMappingName + "'";
                }
