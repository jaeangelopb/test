...
{
    public static class DeleteNOLandFixedAsset
    {
        [FunctionName("DeleteNOLandFixedAsset")]
            ...
            ILogger log)
        {
            ...
            using (SqlConnection conn = new SqlConnection(str))
            {
                ...
                else if(type.Equals("FixedAsset"))
                {
                    Parameter.ParameterName = "@FARId";
                    procName = "[WorkPaper].[sp_FAR_Delete]";
                }
