...
{
    public static class GetDTMFunc
    {
        [FunctionName("GetDTMFunc")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "GetDTM")] HttpRequest req,
            ILogger log)
        {
            ...
            using (SqlConnection conn = new SqlConnection(str))
            {
                ...
                if (name.Equals("DTM"))
                {
                    text = "SELECT * FROM [WorkPaper].[vw_DTM_Workpaper] " +
...

        {
            ...
            DataTable dataTable = new DataTable { TableName = "DTM" };
