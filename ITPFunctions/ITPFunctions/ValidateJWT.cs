    ...
    public class ValidateJWT
    {
        ...
        public ValidateJWT(HttpRequest request)
        {
            ...
            try
            {
                ...
                claims = new JwtBuilder().WithAlgorithm(new HMACSHA256Algorithm()).WithSecret("pass123").MustVerifySignature().Decode<IDictionary<string, object>>(authorizationHeader);
            }
