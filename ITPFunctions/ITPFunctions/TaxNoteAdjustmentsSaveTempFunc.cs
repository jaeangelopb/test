...
{
    public static class TaxNoteAdjustmentsSaveTempFunc
    {
        [FunctionName("TaxNoteAdjustmentsSaveTempFunc")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "TaxNoteAdjustmentsSaveTemporary")] HttpRequestMessage req,
              ILogger log)
        {
            ...
            var fra = JsonConvert.DeserializeObject<IEnumerable<TaxNoteAdjustmentsTemp>>(body as string);
            ...
            using (SqlConnection conn = new SqlConnection(str))
            {
                ...
                foreach (TaxNoteAdjustmentsTemp rowItem in fra)
                {
